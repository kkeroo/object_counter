    ...
    <div className="LoadDataset">
        <Modal show={props.show} onHide={props.onClose}>
            <Modal.Header closeButton>
                <Modal.Title>{props.images.lenght == undefined ? "Upload dataset" : "Current dataset"}</Modal.Title>
            </Modal.Header>
        <Modal.Body>
            <Form onSubmit={props.onSaveDataset} hidden={props.images.lenght != undefined}>
                <Form.Group>
